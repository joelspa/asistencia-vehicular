...
import {
  ...
  StatusBar, ScrollView, Keyboard, KeyboardAvoidingView, Platform,
} from 'react-native';
...
export default function HomeScreen() {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    // Botón fijo en el fondo — siempre visible sobre el tab bar
    bottomArea: {
      paddingHorizontal: spacing.lg,
      paddingTop: spacing.md,
      paddingBottom: Math.max(bottom + spacing.md, spacing.lg),
      backgroundColor: colors.cardBackground,
      borderTopWidth: 1,
  ...
  return (
    <SafeAreaView style={s.screen} edges={['top']}>
      ...
      >
        ...
        {/* Botón CTA — fuera del ScrollView para que siempre esté visible */}
